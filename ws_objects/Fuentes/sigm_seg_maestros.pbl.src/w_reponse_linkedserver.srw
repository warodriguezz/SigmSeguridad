$PBExportHeader$w_reponse_linkedserver.srw
forward
global type w_reponse_linkedserver from w_response_seleccionar
end type
end forward
...
global w_reponse_linkedserver w_reponse_linkedserver

type variables
Integer ii_idRol
end variables

on w_reponse_linkedserver.create
call super::create
end on

on w_reponse_linkedserver.destroy
call super::destroy
end on
...
type cbx_filtros from w_response_seleccionar`cbx_filtros within w_reponse_linkedserver
end type

type dw_principal from w_response_seleccionar`dw_principal within w_reponse_linkedserver
...
type cb_cancelar from w_response_seleccionar`cb_cancelar within w_reponse_linkedserver
end type

type cb_aceptar from w_response_seleccionar`cb_aceptar within w_reponse_linkedserver
end type

type st_filas from w_response_seleccionar`st_filas within w_reponse_linkedserver
end type

type cbx_seleccionar_todo from w_response_seleccionar`cbx_seleccionar_todo within w_reponse_linkedserver
end type
