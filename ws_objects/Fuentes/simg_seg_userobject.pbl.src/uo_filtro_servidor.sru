$PBExportHeader$uo_filtro_servidor.sru
forward
global type uo_filtro_servidor from uo_dwfiltro
end type
end forward
...
integer width = 1527
integer height = 96
string dataobject = "dwf_servidores"
boolean border = false
end type
global uo_filtro_servidor uo_filtro_servidor
...
on uo_filtro_servidor.create
call super::create
end on

on uo_filtro_servidor.destroy
call super::destroy
end on
...
Choose case as_columna 
	case 'idservidor'
		ii_nrofilas = This.idwc_child.Retrieve( 0, 0 ) 
End Choose
